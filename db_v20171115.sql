...
CREATE TABLE `product_role` (
  ...
  KEY `fk_product_role_prd_idx` (`product_id`),
  KEY `fk_prd_role_role_idx` (`role_id`),
...
-- Dump completed on 2017-11-15 23:08:03
