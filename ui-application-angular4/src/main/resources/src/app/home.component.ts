...
@Component({
    ...
    <div class="main-content">
        ...
        <div class="products-grid">
            ...
            <div class="col-md-4 product simpleCart_shelfItem text-center">
                <a href="single.html"><img src="assets/images/p4.jpg" alt="" /></a>
                <div class="mask">
                <a href="single.html">Quick View</a>
                </div>
            ...
            <div class="col-md-4 product simpleCart_shelfItem text-center">
                <a href="single.html"><img src="assets/images/p5.jpg" alt="" /></a>
                <div class="mask">
                <a href="single.html">Quick View</a>
                </div>
            ...
            <div class="col-md-4 product simpleCart_shelfItem text-center">
                <a href="single.html"><img src="assets/images/p6.jpg" alt="" /></a>
                <div class="mask">
                <a href="single.html">Quick View</a>
                </div>
            ...
            <div class="col-md-4 product simpleCart_shelfItem text-center">
                <a href="single.html"><img src="assets/images/p7.jpg" alt="" /></a>
                <div class="mask">
                <a href="single.html">Quick View</a>
                </div>
            ...
            <div class="col-md-4 product simpleCart_shelfItem text-center">
                <a href="single.html"><img src="assets/images/p8.jpg" alt="" /></a>
                <div class="mask">
                <a href="single.html">Quick View</a>
                </div>
                <a class="product_name" href="single.html">perfectly simple</a>
            ...
            <div class="col-md-4 product simpleCart_shelfItem text-center">
                <a href="single.html"><img src="assets/images/p9.jpg" alt="" /></a>
                <div class="mask">
                <a href="single.html">Quick View</a>
                </div>
    ...
    <div class="container">
        ...
        <ul id="flexiselDemo3">
            <li>
                <a href="single.html"><img src="assets/images/l1.jpg" class="img-responsive" alt="" /></a>
            ...
            <li>
                <a href="single.html"><img src="assets/images/l2.jpg" class="img-responsive" alt="" /></a>						
                <div class="product liked-product simpleCart_shelfItem">
            ...
            <li>
                <a href="single.html"><img src="assets/images/l3.jpg" class="img-responsive" alt="" /></a>
                <div class="product liked-product simpleCart_shelfItem">
            ...
            <li>
                <a href="single.html"><img src="assets/images/l4.jpg" class="img-responsive" alt="" /></a>
                <div class="product liked-product simpleCart_shelfItem">
            ...
            <li>
                <a href="single.html"><img src="assets/images/l5.jpg" class="img-responsive" alt="" /></a>
                <div class="product liked-product simpleCart_shelfItem">
                <a class="like_name" href="single.html">perfectly simple</a>
...
export class HomeComponent {
    ...
    ngOnInit() {
        // load js file for only the home component
