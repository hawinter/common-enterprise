...
CREATE TABLE `category` (
  ...
  `type` varchar(45) DEFAULT 'main' COMMENT 'main or sub',
  `desc` text,
...
INSERT INTO `category` VALUES (1,'Man','main',NULL,'2017-11-19 10:23:14','2017-11-19 10:23:14'),(2,'Women','main',NULL,'2017-11-19 10:23:15','2017-11-19 10:23:15'),(3,'Kid','main',NULL,'2017-11-19 10:23:15','2017-11-19 10:23:15'),(4,'Shoes','main',NULL,'2017-11-19 10:23:15','2017-11-19 10:23:15'),(5,'Shirt','main',NULL,'2017-11-27 14:22:30','2017-11-27 14:22:30'),(6,'Trousers','main',NULL,'2017-11-27 14:22:30','2017-11-27 14:22:30'),(7,'Other','main',NULL,'2017-11-27 14:22:30','2017-11-27 14:22:30');
...
CREATE TABLE `order_product` (
  ...
  `update_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `un` (`order_id`,`product_id`),
...
CREATE TABLE `product_category` (
  ...
  `update_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `un` (`product_id`,`category_id`),
  KEY `fk_product_pc_idx` (`product_id`),
  KEY `fk_cate_pc_idx` (`category_id`),
  CONSTRAINT `fk_cate_pc` FOREIGN KEY (`category_id`) REFERENCES `category` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_product_pc` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `product_category` VALUES (1,2,1,NULL,NULL,NULL),(2,2,2,NULL,NULL,NULL),(3,3,1,NULL,NULL,NULL),(4,3,2,NULL,NULL,NULL),(5,4,1,NULL,'2017-11-19 16:27:02','2017-11-19 16:27:02'),(6,4,2,NULL,'2017-11-19 16:27:02','2017-11-19 16:27:02'),(13,8,1,NULL,'2017-11-27 17:17:08','2017-11-27 17:17:08'),(14,8,5,NULL,'2017-11-27 17:17:11','2017-11-27 17:17:11');
...
CREATE TABLE `product_role` (
  ...
  `update_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `un` (`product_id`,`role_id`),
  KEY `fk_product_idx` (`product_id`),
  KEY `fk_role_idx` (`role_id`),
  CONSTRAINT `fk_prd_role_role` FOREIGN KEY (`role_id`) REFERENCES `role` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_product_role_prd` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `product_role`
--

LOCK TABLES `product_role` WRITE;
/*!40000 ALTER TABLE `product_role` DISABLE KEYS */;
INSERT INTO `product_role` VALUES (3,8,3,1100000,'Price for CTV1','2017-11-27 17:17:16','2017-11-27 17:17:16'),(4,8,4,1200000,'Price for CTV2','2017-11-27 17:17:19','2017-11-27 17:17:19'),(5,8,5,1300000,'Price for CTV3','2017-11-27 17:17:23','2017-11-27 17:17:23');
...
INSERT INTO `products` VALUES (2,'The First',500,'short Desc','Japan','Japan','White','L','http://localhost:8085/images/theFirst.jpg','Nice product made in Japan','specifications','Man,Shirt',0,NULL,0,NULL,NULL),(3,'The Second',500,'short Desc','Japan','Japan','Red','XL','http://localhost:8085/images/theSecond.jpg','Nice product made in Japan','specifications','Man,Shirt',0,NULL,0,NULL,NULL),(4,'The Second',500,'short Desc','Japan','Japan','Blue','S','http://localhost:8085/images/theSecond.jpg','Nice product made in Japan','specifications','Man,Shirt',0,NULL,0,'2017-11-19 16:27:01','2017-11-19 16:27:01'),(8,'Áo lông v? Ultra light down',1000000,'Short',NULL,'Japan','Xanh Blue','L',NULL,'Full','Spect','Lông V?, Nh?t',0,NULL,0,'2017-11-27 17:17:01','2017-11-27 17:17:01');
...
INSERT INTO `role` VALUES (1,'ADMIN','admin','2017-11-02 09:04:07','2017-11-02 09:04:07'),(2,'CUSTOMER','customer','2017-11-02 09:04:07','2017-11-02 09:04:07'),(3,'CTV1',NULL,'2017-11-27 16:58:34','2017-11-27 16:58:34'),(4,'CTV2',NULL,'2017-11-27 16:58:34','2017-11-27 16:58:34'),(5,'CTV3',NULL,'2017-11-27 16:58:34','2017-11-27 16:58:34');
...
-- Dump completed on 2017-11-28  0:20:35
